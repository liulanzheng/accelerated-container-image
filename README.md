...
* [overlaybd](https://github.com/alibaba/overlaybd)
    ...
    Overlaybd provides a merged view of block-based layer sequence as [TCMU](https://www.kernel.org/doc/Documentation/target/tcmu-design.txt) server, which works as an iSCSI target server in user space and outputs overlaybd devices through iSCSI protocol.

* overlaybd-snapshotter

    It is a [containerd](https://containerd.io/) snapshotter plugin for overlaybd format images. This snapshotter is compatible for standard OCI images, as well as overlayfs snapshotter.
